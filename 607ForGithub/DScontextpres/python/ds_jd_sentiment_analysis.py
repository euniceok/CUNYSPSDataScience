...
outputfilepath = '/Users/euniceok/PycharmProjects/cuny/spring2019/Week8/Data-607-Project-3/Eunice/output/smalldata'
filename = '/Eunice/source/500_jobs.csv'
...
full.to_csv('/Users/euniceok/PycharmProjects/cuny/spring2019/Week8/Data-607-Project-3/Eunice/sent_scored.csv')
...
# bar plot of industry by average pos sentiment
industry_cts = ind.groupby(['industry'])['compound'].count().sort_values(ascending=False)
fig, ax = plt.subplots(figsize=(8, 8))
counts = industry_cts
sns.barplot(x=counts, y=counts.index, ax=ax, color='b')
# ax.set_xticklabels(['Negative', 'Neutral', 'Positive'])
ax.set_xlabel("Count of JDs")
ax.set_ylabel("Industry")
ax.set_title('Distribution of Data Science Job Descriptions By Industry')
#plt.xticks(rotation=90)
plt.savefig(outputfilepath + '/industry_ct.png',bbox_inches='tight')